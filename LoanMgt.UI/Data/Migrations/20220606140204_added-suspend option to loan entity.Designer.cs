...
namespace LoanMgt.UI.Data.Migrations
{
    ...
    [Migration("20220606140204_added-suspend option to loan entity")]
    partial class addedsuspendoptiontoloanentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoanMgt.SHARED.AccountSettings", b =>
                {
                    ...
                    b.Property<int>("DefaultBadDebtAcc")
                        .HasColumnType("int");

                    b.Property<int>("DefaultBankAcc")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DefaultIncomeAcc")
                        .HasColumnType("int");

                    b.Property<int>("DefaultPayablesAcc")
                        .HasColumnType("int");

                    b.Property<int>("DefaultPurchasesAcc")
                        .HasColumnType("int");

                    b.Property<int>("DefaultReceivablesAcc")
                        .HasColumnType("int");

                    b.Property<int>("DefaultSalesAccount")
                        .HasColumnType("int");

                    b.Property<int>("DefaultTaxAcc")
                        .HasColumnType("int");

                    b.Property<int>("LoanTransactionCode")
                        .HasColumnType("int");

                    b.Property<byte[]>("Logo")
                        .HasColumnType("varbinary(max)");

                    b.Property<int>("MoxPeriodNonPerforming")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoanMgt.SHARED.AttachmentFiles", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.Collateral", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.Expense", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.ExpenseType", b =>
                {
                    b.Property<int>("ExpenseTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoanMgt.SHARED.Investor", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.LoanProduct", b =>
                {
                    ...
                    b.Property<float>("InterimInterest")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("LoanMgt.SHARED.OtherIncome", b =>
                {
                    b.Property<int>("OtherIncomeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OtherIncomeId"), 1L, 1);
            ...
            modelBuilder.Entity("LoanMgt.SHARED.TransactionTemp", b =>
                {
                    b.Property<int>("TransactionTempId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransactionTempId"), 1L, 1);
                    ...
                    b.HasKey("TransactionTempId");

                    b.ToTable("TransactionTemps");
                });
            ...
            modelBuilder.Entity("LoanMgt.SHARED.Expense", b =>
                {
                    b.HasOne("LoanMgt.SHARED.Account", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId");

                    b.HasOne("LoanMgt.SHARED.ExpenseType", "ExpenseType")
                        .WithMany()
            ...
            modelBuilder.Entity("LoanMgt.SHARED.OtherIncome", b =>
                {
                    ...
                    b.HasOne("LoanMgt.SHARED.OtherIncomeType", "OtherIncomeType")
                        .WithMany()
