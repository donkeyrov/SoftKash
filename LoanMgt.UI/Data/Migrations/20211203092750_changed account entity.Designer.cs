...
namespace LoanMgt.UI.Data.Migrations
{
    ...
    [Migration("20211203092750_changed account entity")]
    partial class changedaccountentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoanMgt.SHARED.Profile", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.ProfileModule", b =>
                {
            ...
            modelBuilder.Entity("LoanMgt.SHARED.ProfileModule", b =>
                {
                    b.HasOne("LoanMgt.SHARED.Menu", "Menu")
                        .WithMany()
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoanMgt.SHARED.Profile", "Profile")
