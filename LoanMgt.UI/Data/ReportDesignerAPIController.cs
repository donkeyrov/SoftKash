...
namespace LoanMgt.UI.Data
{
    ...
    public class ReportDesignerAPIController : ControllerBase, IReportDesignerController
    {
        ...
        {
            string dirPath = Path.Combine(this._hostingEnvironment.WebRootPath + "\\" + "resources", key);
        ...
        {
            return ReportDesignerHelper.GetImage(key, image, (IReportDesignerController)this);
        }
